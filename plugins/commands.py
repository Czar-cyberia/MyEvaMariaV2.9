...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/THE_GODLIKE_X')
            ],
            [
                InlineKeyboardButton('⚡ FOLLOW ⚡', url=f"https://t.me/THE_HEAVEN_X"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/THE_HEAVEN_X'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/THE_GODLIKE_X')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/THE_HEAVEN_X') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
